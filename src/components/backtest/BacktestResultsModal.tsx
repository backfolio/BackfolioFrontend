...
const BacktestResultsModal: React.FC<BacktestResultsModalProps> = ({ results, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-xl p-4">
            <div className={`border rounded-3xl shadow-2xl w-full max-w-7xl h-[95vh] overflow-hidden flex flex-col ${isDark ? 'bg-black border-white/[0.15]' : 'bg-white border-gray-200'
                }`}>
                {/* Header */}
                <div className={`relative px-8 py-6 border-b flex-shrink-0 ${isDark ? 'border-white/[0.15]' : 'border-gray-200'
                    }`}>
                    <div className={`absolute inset-0 ${isDark
                            ? 'bg-gradient-to-r from-purple-500/10 via-purple-500/5 to-blue-500/10'
                            : 'bg-gradient-to-r from-primary-500/5 via-purple-500/5 to-blue-500/5'
                        }`}></div>
                    <div className={`absolute top-0 left-20 w-64 h-64 rounded-full blur-3xl ${isDark ? 'bg-purple-500/10' : 'bg-primary-500/5'
                        }`}></div>
                    <div className={`absolute top-0 right-20 w-64 h-64 rounded-full blur-3xl ${isDark ? 'bg-purple-500/10' : 'bg-purple-500/5'
                        }`}></div>

                    <div className="relative flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            <div className={`flex items-center justify-center w-14 h-14 backdrop-blur-xl border rounded-2xl ${isDark ? 'bg-white/[0.05] border-white/[0.15]' : 'bg-gray-100 border-gray-200'
                                }`}>
                                <svg className={`w-7 h-7 ${isDark ? 'text-purple-400' : 'text-gray-900'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div>
                                ...
                                <p className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                                    {portfolioData.length} data points • Historical performance
                                </p>
                            </div>
                        </div>
                        <div className="flex items-center gap-3">
                            {results.length > 1 && (
                                <div className={`flex items-center gap-2 px-4 py-2 backdrop-blur-xl rounded-xl border ${isDark ? 'bg-white/[0.05] border-white/[0.15]' : 'bg-gray-50 border-gray-200'
                                    }`}>
                                    ...
                                    <select
                                        ...
                                        className={`text-sm font-medium rounded-lg px-3 py-1.5 border focus:ring-2 focus:ring-purple-500/20 focus:outline-none transition-all ${isDark
                                                ? 'bg-white/[0.05] text-white border-white/[0.15] focus:border-purple-500'
                                                : 'bg-white text-gray-900 border-gray-200 focus:border-primary-500'
                                            }`}
                                    >
                                        {results.map((r, idx) => (
                            ...
                            <button
                                ...
                                className={`px-4 py-2 backdrop-blur-xl border rounded-xl transition-all duration-300 flex items-center gap-2 text-sm font-medium ${isDark
                            ...
                            <button
                                onClick={onClose}
                                className={`flex items-center justify-center w-10 h-10 backdrop-blur-xl rounded-xl transition-all duration-300 group border ${isDark
                                        ? 'bg-white/[0.05] hover:bg-white/[0.1] border-white/[0.15]'
                                        : 'bg-gray-50 hover:bg-gray-100 border-gray-200'
                                    }`}>
                                <svg className={`w-5 h-5 transition-colors ${isDark ? 'text-gray-400 group-hover:text-white' : 'text-gray-600 group-hover:text-gray-900'
                ...
                {/* Tabs */}
                <div className={`border-b px-8 backdrop-blur-xl flex-shrink-0 ${isDark ? 'bg-white/[0.02] border-white/[0.15]' : 'bg-gray-50 border-gray-200'
                    }`}>
                ...
                {/* Content */}
                <div className={`flex-1 overflow-y-auto p-8 ${isDark ? 'bg-black' : 'bg-white'}`}>
                    <div className="fixed inset-0 pointer-events-none">
                        <div className={`absolute top-40 left-20 w-96 h-96 rounded-full blur-3xl ${isDark ? 'bg-purple-500/5' : 'bg-primary-500/3'
                            }`}></div>
                        <div className={`absolute bottom-20 right-40 w-96 h-96 rounded-full blur-3xl ${isDark ? 'bg-purple-500/5' : 'bg-purple-500/3'
                            }`}></div>
                    </div>
                        ...
                        <div className="relative space-y-6">
                            ...
                            {results.length > 1 && (
                                <div className={`backdrop-blur-xl border rounded-2xl p-6 shadow-sm ${isDark ? 'bg-white/[0.02] border-white/[0.15]' : 'bg-white border-gray-200'
                                    ...
                                    <h3 className={`text-lg font-bold mb-4 flex items-center gap-2 ${isDark ? 'text-white' : 'text-gray-900'
                                        ...
                                        <svg className={`w-5 h-5 ${isDark ? 'text-purple-400' : 'text-primary-400'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div className="overflow-x-auto">
                                        <table className="w-full text-sm">
                                            <thead>
                                                <tr className={`border-b ${isDark ? 'border-white/[0.1]' : 'border-gray-200'}`}>
                                                    <th className={`text-left py-3 px-4 font-medium ${isDark ? 'text-gray-400' : 'text-gray-600'
                                                        }`}>
                                                        Metric
                                                    </th>
                                                    {results.map((r, idx) => (
                                                        <th key={idx} className={`text-right py-3 px-4 font-semibold ${isDark ? 'text-gray-200' : 'text-gray-700'
                                                            }`}>
                                                            {r.strategyName || `Strategy ${idx + 1}`}
                                                        </th>
                                                    ))}
                                            ...
                                            <tbody>
                                                {[
                                                    ...
                                                    return (
                                                        <tr key={metric.key} className={`border-b transition-colors ${isDark
                                                            ...
                                                            {results.map((r, idx) => {
                                                                ...
                                                                let textColor = isDark ? 'text-gray-200' : 'text-gray-800'
                                                                if (metric.colorCode) {
                                                                ...
                                                                return (
                                                                    <td key={idx} className={`py-3 px-4 text-right font-semibold ${textColor} ${isBest
                                                                            ? isDark
                                                                        ...
                                                                        {displayValue}
                                                                        {isBest && <span className={`ml-2 text-xs ${isDark ? 'text-purple-400' : 'text-primary-400'
                                                                            }`}>★</span>}
                                                                    </td>
                                                                )
                                                            })}
                            ...
                            {(data_quality || transaction_analysis) && (
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    {data_quality && (
                                        <div className={`backdrop-blur-xl border rounded-xl p-6 shadow-sm ${isDark ? 'bg-white/[0.02] border-white/[0.15]' : 'bg-white border-gray-200'
                                            }`}>
                                            ...
                                            <div className="space-y-3">
                                                <div className="flex justify-between items-center">
                                                    <span className={isDark ? 'text-gray-400' : 'text-gray-600'}>Total Days</span>
                                                    <span className={`font-semibold ${isDark ? 'text-white' : 'text-gray-900'}`}>
                                                        {data_quality.total_days}
                                                    </span>
                                                </div>
                                                <div className="flex justify-between items-center">
                                                    <span className={isDark ? 'text-gray-400' : 'text-gray-600'}>Missing Days</span>
                                                    <span className={`font-semibold ${isDark ? 'text-white' : 'text-gray-900'}`}>
                                                        {data_quality.missing_days}
                                                    </span>
                                                </div>
                                                <div className="flex justify-between items-center">
                                                    <span className={isDark ? 'text-gray-400' : 'text-gray-600'}>Data Completeness</span>
                                                    <span className={`font-semibold ${isDark ? 'text-emerald-400' : 'text-emerald-600'}`}>
                                                        {formatMetric(data_quality.data_completeness * 100, true)}
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className={`backdrop-blur-xl border rounded-xl p-6 shadow-sm ${isDark ? 'bg-white/[0.02] border-white/[0.15]' : 'bg-white border-gray-200'
                                            ...
                                            <div className="space-y-3">
                                                {transaction_analysis.total_trades !== undefined && (
                                                    <div className="flex justify-between items-center">
                                                        <span className={isDark ? 'text-gray-400' : 'text-gray-600'}>Total Trades</span>
                                                        <span className={`font-semibold ${isDark ? 'text-white' : 'text-gray-900'}`}>
                                                            {transaction_analysis.total_trades}
                                                        </span>
                                                    </div>
                                                )}
                                                {transaction_analysis.avg_holding_period !== undefined && (
                                                    <div className="flex justify-between items-center">
                                                        <span className={isDark ? 'text-gray-400' : 'text-gray-600'}>Avg Holding Period</span>
                                                        <span className={`font-semibold ${isDark ? 'text-white' : 'text-gray-900'}`}>
                                                            {transaction_analysis.avg_holding_period.toFixed(1)} days
                                                        </span>
                                                    </div>
                                                )}
                                                {transaction_analysis.turnover_ratio !== undefined && (
                                                    <div className="flex justify-between items-center">
                                                        <span className={isDark ? 'text-gray-400' : 'text-gray-600'}>Turnover Ratio</span>
                                                        <span className={`font-semibold ${isDark ? 'text-white' : 'text-gray-900'}`}>
                                                            {formatMetric(transaction_analysis.turnover_ratio * 100, true)}
                                                        </span>
                                                    </div>
                                                )}
                                                {transaction_analysis.total_commissions !== undefined && (
                                                    <div className="flex justify-between items-center">
                                                        <span className={isDark ? 'text-gray-400' : 'text-gray-600'}>Total Commissions</span>
                                                        <span className={`font-semibold ${isDark ? 'text-red-400' : 'text-red-600'}`}>
                                                            {formatCurrency(transaction_analysis.total_commissions)}
                                                        </span>
                                                    </div>
                                                )}
                                            </div>
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                                        {risk_metrics.value_at_risk_95 !== undefined && (
                                            <div className={`border rounded-lg p-4 ${isDark ? 'bg-white/[0.02] border-white/[0.1]' : 'bg-gray-50 border-gray-200'
                                                ...
                                                <div className={`text-xl font-bold ${isDark ? 'text-white' : 'text-gray-900'}`}>
                                                    {formatMetric(risk_metrics.value_at_risk_95 * 100, true)}
                                                </div>
                                            </div>
                                        )}
                                        {risk_metrics.conditional_var_95 !== undefined && (
                                            <div className={`border rounded-lg p-4 ${isDark ? 'bg-white/[0.02] border-white/[0.1]' : 'bg-gray-50 border-gray-200'
                                                ...
                                                <div className={`text-xl font-bold ${isDark ? 'text-white' : 'text-gray-900'}`}>
                                                    {formatMetric(risk_metrics.conditional_var_95 * 100, true)}
                                                </div>
                                            </div>
                                        )}
                                        {risk_metrics.downside_deviation !== undefined && (
                                            <div className={`border rounded-lg p-4 ${isDark ? 'bg-white/[0.02] border-white/[0.1]' : 'bg-gray-50 border-gray-200'
                                                ...
                                                <div className={`text-xl font-bold ${isDark ? 'text-white' : 'text-gray-900'}`}>
                                                    {formatMetric(risk_metrics.downside_deviation * 100, true)}
                                                </div>
                                            </div>
                                        )}
                                        {risk_metrics.upside_potential !== undefined && (
                                            <div className={`border rounded-lg p-4 ${isDark ? 'bg-white/[0.02] border-white/[0.1]' : 'bg-gray-50 border-gray-200'
                                                ...
                                                <div className={`text-xl font-bold ${isDark ? 'text-emerald-400' : 'text-emerald-600'}`}>
                                                    {formatMetric(risk_metrics.upside_potential * 100, true)}
                                                </div>
                                            </div>
                                        )}
                                        {risk_metrics.omega_ratio !== undefined && (
                                            <div className={`border rounded-lg p-4 ${isDark ? 'bg-white/[0.02] border-white/[0.1]' : 'bg-gray-50 border-gray-200'
                                                ...
                                                <div className={`text-xl font-bold ${isDark ? 'text-white' : 'text-gray-900'}`}>
                                                    {formatMetric(risk_metrics.omega_ratio)}
                                                </div>
                                            </div>
                                        )}
                                        {risk_metrics.skewness !== undefined && (
                                            <div className={`border rounded-lg p-4 ${isDark ? 'bg-white/[0.02] border-white/[0.1]' : 'bg-gray-50 border-gray-200'
                                                ...
                                                <div className={`text-xl font-bold ${isDark ? 'text-white' : 'text-gray-900'}`}>
                                                    {formatMetric(risk_metrics.skewness)}
                                                </div>
                                            </div>
                                        )}
                                        {risk_metrics.kurtosis !== undefined && (
                                            <div className={`border rounded-lg p-4 ${isDark ? 'bg-white/[0.02] border-white/[0.1]' : 'bg-gray-50 border-gray-200'
                                                ...
                                                <div className={`text-xl font-bold ${isDark ? 'text-white' : 'text-gray-900'}`}>
                                                    {formatMetric(risk_metrics.kurtosis)}
                                                </div>
                                            </div>
                                        )}
                                    </div>
                                        ...
                                        <div key={name}>
                                            <div className="flex justify-between items-center mb-2">
                                                ...
                                                <span className={`text-sm font-bold ${isDark ? 'text-white' : 'text-gray-900'
                                                    ...
                                                    {formatMetric(percentage as number, true)}
                                                </span>
                                            </div>
                                            <div className={`w-full rounded-full h-3 overflow-hidden ${isDark ? 'bg-white/[0.1]' : 'bg-gray-200'
                                                }`}>
                                                <div
                                        ...
                                        <table className="min-w-full text-sm">
                                            ...
                                            <tbody>
                                                {allocationData.slice(0, 50).map((item, idx) => (
                                                    <tr key={idx} className={`border-b transition-colors ${isDark
                                                            ? 'border-white/[0.05] hover:bg-white/[0.02]'
                                                            : 'border-gray-200 hover:bg-gray-50'
                                                        }`}>
                                                        <td className={`py-2 px-3 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                                                            {item.date}
                                                        </td>
                    ...
                    {apiResult.warnings && apiResult.warnings.length > 0 && (
                        <div className={`border rounded-xl p-6 shadow-sm ${isDark ? 'bg-amber-500/10 border-amber-500/30' : 'bg-amber-50 border-amber-200'
                            }`}>

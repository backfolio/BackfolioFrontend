    ...
    return (
        <>
            ...
            <button
                ...
                className="fixed top-6 left-6 z-50 p-3 bg-white/95 backdrop-blur-sm rounded-xl shadow-lg hover:shadow-xl border border-slate-200/50 hover:bg-white transition-all hover:scale-105"
                title="Menu"
            >
            ...
            {showMenu && (
                <>
                    ...
                    <div className="fixed left-6 top-6 w-80 bg-white rounded-2xl shadow-2xl z-50 border border-slate-200/50">
                        <div className="p-6">
                            {/* Header with Logo */}
                            ...
                            <div className="space-y-1 mb-6">
                                ...
                                <button
                                    ...
                                    className="w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all font-medium bg-gradient-to-br from-violet-500/90 via-purple-600/85 to-fuchsia-500/80 hover:from-violet-600/95 hover:via-purple-700/90 hover:to-fuchsia-600/85 text-white shadow-md hover:shadow-lg relative overflow-hidden group"
                                >
                                    ...
                                    <span className="text-sm font-semibold relative z-10">AI Chat</span>
                                    <span className="text-xs text-yellow-200 ml-auto relative z-10">✨</span>
                                </button>
                            ...
                            <div className="space-y-2">
                                ...
                                <button
                                    ...
                                    className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-lg transition-all text-sm font-semibold"
                                >
